                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Jobseeker Registration</a>
                            <a href="{{ url('register-employer/create') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Employer Registration </a>
                        @endif
                    @endauth
                </div>
            @endif
